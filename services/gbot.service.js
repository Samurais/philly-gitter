 ...
 */
GBot.prototype.makeListOptions = function(output) {
    let matches = [];
...
GBot.prototype.findListOption = function(input) {
...
GBot.prototype.parseInput = function(message) {
...
GBot.prototype.cleanInput = function(input) {
...
GBot.prototype.announce = function(opts) {
    clog('announce', opts);
    this.joinRoom(opts, true);
}

GBot.prototype.joinRoom = function(opts) {
